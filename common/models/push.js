"use strict";
// this model is simple for testing purpose
module.exports = function(Push) {
  const { Expo } = require("expo-server-sdk");

  // Create a new Expo SDK client
  let expo = new Expo();
  // console.log("this is new Expo", expo);
  Push.push = async function(rest, options) {
  ...
  Push.observe("before save", async (ctx, next) => {
